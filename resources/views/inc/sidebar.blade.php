                        ...
                        <div class="list-group" id="contacts" role="tablist">
                            ...
                            @else
                                @foreach($friends as $friend)
                                    <a href="#" class="filterMembers all {{ $friend->isOnline() ? 'online' : 'offline' }} contact" data-toggle="modal" data-target="#friendModal" data-friend-name="{{ $friend->name }}" data-friend-username="{{ $friend->username }}" data-friend-thumbnail="{{ $friend->thumbnail }}" data-friend-since="{{ auth()->user()->getFriendship($friend)->created_at }}">
